  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pt-10 relative z-10">
        ...
        {/* Login Buttons - Glass Morphism Style */}
        ...
        <div className="flex items-center gap-4 mt-6">
          <button 
            onClick={onLogin}
            className="w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center transition-all duration-300 active:scale-95 shadow-lg shadow-[#25D366]/20"
          >
          ...
          <button 
            onClick={onLogin}
            className="w-12 h-12 rounded-full glass border border-border/20 flex items-center justify-center transition-all duration-300 active:scale-95"
          >
