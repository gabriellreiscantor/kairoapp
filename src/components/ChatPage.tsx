      ...
      <header className="fixed top-0 left-0 right-0 z-50 safe-area-top">
        ...
        <div className="relative flex items-center justify-center gap-2 px-4 py-3">
          ...
          <button
            ...
            className="w-11 h-11 rounded-full flex items-center justify-center transition-all duration-300 bg-muted/50 hover:bg-muted"
          >
            <User className="w-5 h-5 text-foreground" fill="currentColor" />
          </button>
        </div>
      </header>
